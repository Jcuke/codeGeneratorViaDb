package com.jcuke.plugin.gui;

import com.jcuke.plugin.Holder;
import com.jcuke.plugin.component.AutoGeneratorConfig;
import com.jcuke.plugin.component.AutoGeneratorSettings;
import com.jcuke.plugin.entity.Table;
import com.jcuke.plugin.entity.TableSchema;
import com.jcuke.plugin.util.Args;
import com.jcuke.plugin.util.StringHelper;
...
import static com.jcuke.plugin.util.Key.createKey;
...
public class AutoGeneratorSettingsFrame {
  ...
  private void saveTextField(AutoGeneratorConfig config) {
    ...
    applicationProperties.setValue(createKey("use_lombok"), String.valueOf(config.isUseLombok()));
    applicationProperties.setValue(createKey("generate_repository"), String.valueOf(config.isGenerateRepository()));
    applicationProperties.setValue(createKey("implement_serializable"), String.valueOf(config.isImplementSerializable()));
    applicationProperties.setValue(createKey("generate_class_comment"), String.valueOf(config.isGenerateClassComment()));
    applicationProperties.setValue(createKey("generate_field_comment"), String.valueOf(config.isGenerateFieldComment()));
    applicationProperties.setValue(createKey("generate_method_comment"), String.valueOf(config.isGenerateMethodComment()));
