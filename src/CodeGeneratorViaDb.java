import com.ifengxue.fastjdbc.*;
import com.jcuke.plugin.Holder;
import com.jcuke.plugin.component.DatabaseSettings;
import com.jcuke.plugin.entity.TableSchema;
import com.jcuke.plugin.gui.AutoGeneratorSettingsFrame;
...
/**
 * Created by cuke on 2018/6/19.
 */
public class CodeGeneratorViaDb extends AnAction {
    static {
        try {
            ...
            new Thread(() -> {
                ...
                try {
                    ...
                    ApplicationManager.getApplication()
                            .invokeLater(() -> Notifications.Bus.notify(new Notification("JpaSupport", "Error",
